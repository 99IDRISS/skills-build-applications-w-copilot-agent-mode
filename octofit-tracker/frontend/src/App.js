    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="mt-5"><h1 className="display-4">Bienvenue sur Octofit Tracker !</h1><p className="lead">Suivez vos activités, vos équipes et vos performances.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
